...
{
    StructuredBuffer<SceneConstantBuffer> cbv = ResourceDescriptorHeap[0];
    StructuredBuffer<IndirectCommand> inputCommands = ResourceDescriptorHeap[1];
    AppendStructuredBuffer<IndirectCommand> outputCommands = ResourceDescriptorHeap[2];
